...
import { Bot, MessageSquare, BarChart3, Settings as SettingsIcon, Rocket } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="bg-slate-900/80 border border-gray-700/50 p-1 gap-1 rounded-xl backdrop-blur-sm grid grid-cols-5">
          <TabsTrigger
            value="exercito"
